...
export default class FavoritesController {
  ...
  deleteTrackFromFavs(
    ...
    return this.favoritesService.deleteFromFavs(id, 'tracks', res);
  }
  ...
  deleteAlbumFromFavs(
    ...
    return this.favoritesService.deleteFromFavs(id, 'albums', res);
  }
  ...
  deleteArtistFromFavs(
    ...
    return this.favoritesService.deleteFromFavs(id, 'artists', res);
  }
}
